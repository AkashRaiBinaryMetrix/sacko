...
<div class="container-fluid flex-grow-1 container-p-y">
    <h4 class="font-weight-bold py-3 mb-0">@lang('message.import_incentive')</h4>
    <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="feather icon-home"></i></a></li>
            <li class="breadcrumb-item"><a href="{{ route('admin.incentive.index') }}">@lang('message.incentive')</a></li>
            <li class="breadcrumb-item active">@lang('message.import_incentive')</li>
        </ol>
    </div>
    <div class="row">
            ...
            <div class="col-md-12">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="account-general">
                    	<form role="form" action="{{ url('admin/incentive/import_store') }}" method="POST" enctype="multipart/form-data" autocomplete="off"> 
                       		...
                       		<div class="card-body">
                                <div class="form-row">
                                    ...
                                    <div class="raj">
                                        ...
                                        <a href="{{ asset('assets/import/incentive.xlsx') }}" download="incentive"c lass="btn btn-info">Download</a>
                                        </p>
                                    </div>
                                </div>
