...
<div class="container-fluid flex-grow-1 container-p-y">
	<h4 class="font-weight-bold py-3 mb-0">@lang('message.incentive_list') ({{ count($datacountlists)}})</h4>
				...
				<div class="card-body">
					<div class="row align-items-center m-l-0">
						...
						<div class="col-sm-2 text-right">
						  <a href="{{ url('admin/incentive/export') }}" data-size="xl" class="btn btn-warning btn-sm mb-3 btn-round"><i class="feather"></i> Export</a>
						</div>
						<div class="col-sm-2 text-right">
						  <a href="{{ url('admin/incentive/import') }}" data-size="xl" class="btn btn-info btn-sm mb-3 btn-round"><i class="feather icon-plus"></i> Add Import </a>
						</div>
					    <div class="col-sm-2 text-right">
						...
						<div class="col-sm-2 text-right">
						  <a href="{{ url('admin/incentive/create') }}" data-size="xl" class="btn btn-success btn-sm mb-3 btn-round"><i class="feather icon-plus"></i> Add incentive </a>
						</div>
					</div>
					<div class="row">
							...
							<table id="report-table" class="table table-bordered table-striped mb-0">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a data-size="lg"  class="btn btn-icon btn-outline-primary" data-toggle="tooltip" title="View" href="{{ url('admin/incentive/view',$val->id) }}">
        ...
        for(i=0;i<element_lenght;i++)
        {
			if(formid.elements[i].name=="mul_del[]")
			{
				if(formid.elements[i].checked==true)
				{
					...
					{
						$("#formid").attr("action", "{{url('admin/incentive/delete')}}");
						this.formid.submit();
						break;
					}
				}	
