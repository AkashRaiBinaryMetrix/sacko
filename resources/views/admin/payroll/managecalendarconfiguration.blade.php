...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Payroll Management / Configure Holidays</li>
        </ol>
    </div>
    <div class="row">
                       		...
                       		<div class="card-body">
								<div class="form-row">
									<div class="form-group col-md-6">
										...
										<input type="date" class="form-control mb-1" required name="date_selection" id="datepicker" value="{{old('date_select')}}">
