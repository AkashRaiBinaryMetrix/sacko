...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Edit Project / Project Scope</li>
        </ol>
    </div>
    <div class="row">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="account-general">
                    	<form role="form" action="{{ route('admin.manage.updateproject') }}" method="POST" enctype="multipart/form-data"> 
                        	...
                        	<h6 class="card-header" style="color:blue;">Edit Project</Details></h6>
                       		<div class="card-body">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										...
										<input type="text" class="form-control mb-1" required name="project_description" value="{{$projectlist->descr}}">
...
<div id="TextBoxesGroup">
						            <div class="form-row">  
													...
													<div class="form-group col-md-4">
															...
															<input type="time" class="form-control mb-1 shift_start_date" required name="shift_start_date[]">
					                                        <div class="clearfix"></div>
													</div>
													<div class="form-group col-md-4">
