		...
		<div class="row justify-content-between align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-4 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
				<div class="d-inline-block">
					<h5 class="h4 d-inline-block font-weight-400 mb-0 "> Create Holiday Session
					</h5>
				</div>
			</div>
		</div>
	...
	<div class="row">
		...
		<div class="col">
			<div class="card bg-none card-box">
				<form class="p-4" action="{{ route('holiday-session.store') }}" method="POST">
					...
					<div class="row">
						<div class="form-group col-lg-6 col-md-6">
							...
							<select class="form-control select2 select2-hidden-accessible" name="group_id" >                       
								...
								<option value='{{$val->id}}' @if(old('group_id')==$val->id){{'selected="true"'}}@endif >{{$val->name}}</option>
								@endforeach
							</select> 
										...
										<td>
											<div class="row">
												<div class="col-md-3 custom-control custom-checkbox">
													<input class="custom-control-input" id="can_manage{{$key}}" name="can_manage[{{$dash->id}}]" type="checkbox" value="1">
