		...
		<div class="row justify-content-between align-items-center">
			<div class="col-xl-4 col-lg-4 col-md-4 d-flex align-items-center justify-content-between justify-content-md-start mb-3 mb-md-0">
				<div class="d-inline-block">
					<h5 class="h4 d-inline-block font-weight-400 mb-0 "> Holiday Sessions ({{ count($datacountlists)}})
			...
			<div class="col-xl-8 col-lg-8 col-md-8 d-flex align-items-center justify-content-between justify-content-md-end">
				<div class="all-button-box row d-flex justify-content-end">
					<div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
						<a href="{{ route('holiday-session.create') }}" data-size="xl"  data-title="{{__('Add New')}}" class="btn btn-xs btn-white btn-icon-only width-auto">
							<i class="fa fa-plus"></i> {{__('Add Session')}}
						</a>
					</div>
					<div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                                ...
                                <table class="table align-items-center">
                                    ...
                                    <tbody class="list">
										...
										<tr>
											...
											<td>
											  <a data-size="lg"  class="edit-icon" data-toggle="tooltip" title="Edit" href="{{ url('holiday-session/edit',$val->id) }}">
...
{   
	$.ajax({
		...
		url: "{{url('holiday-session/status')}}",
	...
	for(i=0;i<element_lenght;i++)
	{
		if(formid.elements[i].name=="mul_del[]")
		{
			if(formid.elements[i].checked==true)
			{
				...
				{
					$("#formid").attr("action", "{{url('holiday-session/delete')}}");
					this.formid.submit();
					break;
				}
			}	
