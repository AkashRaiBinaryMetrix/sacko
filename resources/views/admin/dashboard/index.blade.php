...
var oData = {
  "{{$line['5']['year']}}": {{$line['5']['count']}},
  "{{$line['4']['year']}}": {{$line['4']['count']}},
  "{{$line['3']['year']}}": {{$line['3']['count']}},
  "{{$line['2']['year']}}": {{$line['2']['count']}},
  "{{$line['1']['year']}}": {{$line['1']['count']}},
  "{{$line['0']['year']}}": {{$line['0']['count']}},
};
