...
<div class="container-fluid flex-grow-1 container-p-y">
	<h4 class="font-weight-bold py-3 mb-0">@lang('message.salary_list') ({{ count($datacountlists)}})</h4>
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="col-sm-1 text-left">
						  <a href="{{ url('admin/salary/export') }}" data-size="xl" class="btn btn-warning btn-sm mb-3 btn-round"> Export </a>
						</div>
						<div class="col-sm-2 text-right">
						  <a href="{{ url('admin/salary/import') }}" data-size="xl" class="btn btn-info btn-sm mb-3 btn-round"><i class="feather icon-plus"></i> Add Import </a>
						</div>
					    <div class="col-sm-2 text-right">
						...
						<div class="col-sm-2 text-right">
						  <a href="{{ url('admin/salary/create') }}" data-size="xl" class="btn btn-success btn-sm mb-3 btn-round"><i class="feather icon-plus"></i> Add salary </a>
						</div>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a data-size="lg"  class="btn btn-icon btn-outline-primary" data-toggle="tooltip" title="View" href="{{ url('admin/salary/view',$val->id) }}">
        ...
        for(i=0;i<element_lenght;i++)
        {
			if(formid.elements[i].name=="mul_del[]")
			{
				if(formid.elements[i].checked==true)
				{
					...
					{
						$("#formid").attr("action", "{{url('admin/salary/delete')}}");
						this.formid.submit();
						break;
					}
				}	
